#!/usr/bin/env python3
"""
Polymarket v103 MCP Server - FastMCP with D402 Transport Wrapper
...
logger = logging.getLogger('polymarket-v103_mcp')
...
logger.info("="*80)
logger.info(f"Polymarket v103 MCP Server (FastMCP + D402 Wrapper)")
logger.info(f"API: https://gamma-api.polymarket.com")
logger.info(f"Payment: {SERVER_ADDRESS}")
logger.info("="*80)

# Create FastMCP server
mcp = FastMCP("Polymarket v103 MCP Server", host="0.0.0.0")
...
# - POLYMARKET_V103_API_KEY: Server's internal API key for payment mode
#
...
@require_payment_for_tool(
    ...
    description="Get BTC events from polymarket"
...
async def btc(
    ...
    """
    Get BTC events from polymarket

    Generated from OpenAPI endpoint: GET /public-search

    Args:
        context: MCP context (auto-injected by framework, not user-provided)
        q: No description (optional, default: "btc")
        page: No description (optional, default: "1")
        limit_per_type: No description (optional, default: "20")
        type: No description (optional, default: "events")
        events_status: No description (optional, default: "active")
        sort: No description (optional, default: "volume_24hr")
        presets: No description (optional, default: "Events")
    ...
    try:
        ...
        logger.error(f"Error in btc: {e}")
        return {"error": str(e), "endpoint": "/public-search"}
...
@require_payment_for_tool(
    ...
    description="Get ethereum polymarket events"
...
async def eth(
    ...
    """
    Get ethereum polymarket events

    Generated from OpenAPI endpoint: GET /public-search

    Args:
        context: MCP context (auto-injected by framework, not user-provided)
        q: No description (optional, default: "eth")
        page: No description (optional, default: "1")
        limit_per_type: No description (optional, default: "20")
        type: No description (optional, default: "events")
        events_status: No description (optional, default: "active")
...
@require_payment_for_tool(
    ...
    description="Get Solana polymarket events"
...
async def solana(
    ...
    """
    Get Solana polymarket events

    Generated from OpenAPI endpoint: GET /public-search

    Args:
        context: MCP context (auto-injected by framework, not user-provided)
        q: No description (optional, default: "solana")
        page: No description (optional, default: "1")
        limit_per_type: No description (optional, default: "20")
        type: No description (optional, default: "events")
        events_status: No description (optional, default: "active")
    ...
    try:
        ...
        logger.error(f"Error in solana: {e}")
        return {"error": str(e), "endpoint": "/public-search"}
...
@require_payment_for_tool(
    ...
    description="Get XRP events from polymarket"
...
async def xrp(
    ...
    """
    Get XRP events from polymarket

    Generated from OpenAPI endpoint: GET /public-search

    Args:
        context: MCP context (auto-injected by framework, not user-provided)
        q: No description (optional, default: "xrp")
        page: No description (optional, default: "1")
        limit_per_type: No description (optional, default: "20")
        type: No description (optional, default: "events")
        events_status: No description (optional, default: "active")
...
def create_app_with_middleware():
    ...
    app.add_middleware(
        ...
        server_name="polymarket-v103-mcp-server"  # MCP server ID for tracking
    )
    ...
    async def health_check(request: Request) -> JSONResponse:
        ...
        return JSONResponse(
            content={
                "status": "healthy",
                "service": "polymarket-v103-mcp-server",
...
if __name__ == "__main__":
    logger.info("="*80)
    logger.info(f"Starting Polymarket v103 MCP Server")
    logger.info("="*80)
